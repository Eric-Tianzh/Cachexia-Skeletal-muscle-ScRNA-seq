...
sc.pl.umap(adata_all,color=["labels"],legend_loc="on data",legend_fontsize=6,frameon=False,palette=color_dict,save='figure1e.pdf')
...
sc.pl.dotplot(adata_all, ['Cd79a', 'Cd19','Cd68','Cd14','Csf3r','S100a9','Cd3d','Nkg7',
                     ...
                     groupby="labels",figsize=(9,7),swap_axes=True,categories_order=group, standard_scale="var", save='figure1f.pdf')

###--UMAP plot of characteristic genes in MuSCs--###
sc.pl.umap(data,color=['Pax7','Myod1'],legend_loc="on data",legend_fontsize='x-small',frameon=False,save='figure1h.pdf')
